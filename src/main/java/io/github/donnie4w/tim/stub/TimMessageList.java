            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.messageList = new java.util.ArrayList<TimMessage>(_list160.size);
                @org.apache.thrift.annotation.Nullable TimMessage _elem161;
                for (int _i162 = 0; _i162 < _list160.size; ++_i162)
                {
                  _elem161 = new TimMessage();
                  _elem161.read(iprot);
                  struct.messageList.add(_elem161);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.messageList != null) {
        if (struct.isSetMessageList()) {
          oprot.writeFieldBegin(MESSAGE_LIST_FIELD_DESC);
          {
            ...
            for (TimMessage _iter163 : struct.messageList)
            {
      ...
      if (struct.isSetMessageList()) {
        {
          ...
          for (TimMessage _iter164 : struct.messageList)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.messageList = new java.util.ArrayList<TimMessage>(_list165.size);
          @org.apache.thrift.annotation.Nullable TimMessage _elem166;
          for (int _i167 = 0; _i167 < _list165.size; ++_i167)
          {
            _elem166 = new TimMessage();
            _elem166.read(iprot);
            struct.messageList.add(_elem166);
          }
        }
        struct.setMessageListIsSet(true);
      }
