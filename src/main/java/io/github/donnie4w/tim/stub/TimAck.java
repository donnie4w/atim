...
public class TimAck implements org.apache.thrift.TBase<TimAck, TimAck._Fields>, java.io.Serializable, Cloneable, Comparable<TimAck> {
  ...
  public @org.apache.thrift.annotation.Nullable String n2; // optional
  ...
  public TimAck setN2(@org.apache.thrift.annotation.Nullable String n2) {
    this.n2 = n2;
    return this;
  }
  ...
  public int compareTo(TimAck other) {
    ...
    lastComparison = Boolean.compare(isSetT2(), other.isSetT2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetT2()) {
    ...
    lastComparison = Boolean.compare(isSetN2(), other.isSetN2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetN2()) {
