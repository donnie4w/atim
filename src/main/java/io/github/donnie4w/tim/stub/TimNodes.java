...
public class TimNodes implements org.apache.thrift.TBase<TimNodes, TimNodes._Fields>, java.io.Serializable, Cloneable, Comparable<TimNodes> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.usermap = new java.util.HashMap<String,TimUserBean>(2*_map135.size);
                @org.apache.thrift.annotation.Nullable String _key136;
                @org.apache.thrift.annotation.Nullable TimUserBean _val137;
                for (int _i138 = 0; _i138 < _map135.size; ++_i138)
                {
                  _key136 = iprot.readString();
                  _val137 = new TimUserBean();
                  _val137.read(iprot);
                  struct.usermap.put(_key136, _val137);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.roommap = new java.util.HashMap<String,TimRoomBean>(2*_map139.size);
                @org.apache.thrift.annotation.Nullable String _key140;
                @org.apache.thrift.annotation.Nullable TimRoomBean _val141;
                for (int _i142 = 0; _i142 < _map139.size; ++_i142)
                {
                  _key140 = iprot.readString();
                  _val141 = new TimRoomBean();
                  _val141.read(iprot);
                  struct.roommap.put(_key140, _val141);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.nodelist != null) {
        if (struct.isSetNodelist()) {
          oprot.writeFieldBegin(NODELIST_FIELD_DESC);
          {
            ...
            for (String _iter143 : struct.nodelist)
            {
      ...
      if (struct.usermap != null) {
        if (struct.isSetUsermap()) {
          oprot.writeFieldBegin(USERMAP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, TimUserBean> _iter144 : struct.usermap.entrySet())
            {
      ...
      if (struct.roommap != null) {
        if (struct.isSetRoommap()) {
          oprot.writeFieldBegin(ROOMMAP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, TimRoomBean> _iter145 : struct.roommap.entrySet())
            {
  ...
  private static class TimNodesTupleScheme extends org.apache.thrift.scheme.TupleScheme<TimNodes> {
      ...
      if (struct.isSetNodelist()) {
        {
          ...
          for (String _iter146 : struct.nodelist)
          {
      ...
      if (struct.isSetUsermap()) {
        {
          ...
          for (java.util.Map.Entry<String, TimUserBean> _iter147 : struct.usermap.entrySet())
          {
      ...
      if (struct.isSetRoommap()) {
        {
          ...
          for (java.util.Map.Entry<String, TimRoomBean> _iter148 : struct.roommap.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TimNodes struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.nodelist = new java.util.ArrayList<String>(_list149.size);
          @org.apache.thrift.annotation.Nullable String _elem150;
          for (int _i151 = 0; _i151 < _list149.size; ++_i151)
          {
            _elem150 = iprot.readString();
            struct.nodelist.add(_elem150);
          }
        }
        struct.setNodelistIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map152 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT); 
          struct.usermap = new java.util.HashMap<String,TimUserBean>(2*_map152.size);
          @org.apache.thrift.annotation.Nullable String _key153;
          @org.apache.thrift.annotation.Nullable TimUserBean _val154;
          for (int _i155 = 0; _i155 < _map152.size; ++_i155)
          {
            _key153 = iprot.readString();
            _val154 = new TimUserBean();
            _val154.read(iprot);
            struct.usermap.put(_key153, _val154);
          }
        }
        struct.setUsermapIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.roommap = new java.util.HashMap<String,TimRoomBean>(2*_map156.size);
          @org.apache.thrift.annotation.Nullable String _key157;
          @org.apache.thrift.annotation.Nullable TimRoomBean _val158;
          for (int _i159 = 0; _i159 < _map156.size; ++_i159)
          {
            _key157 = iprot.readString();
            _val158 = new TimRoomBean();
            _val158.read(iprot);
            struct.roommap.put(_key157, _val158);
          }
        }
        struct.setRoommapIsSet(true);
      }
