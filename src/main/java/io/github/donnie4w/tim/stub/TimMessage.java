...
public class TimMessage implements org.apache.thrift.TBase<TimMessage, TimMessage._Fields>, java.io.Serializable, Cloneable, Comparable<TimMessage> {
  ...
  private static final org.apache.thrift.protocol.TField TO_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("ToList", org.apache.thrift.protocol.TType.LIST, (short)17);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<String> ToList; // optional
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.MID,_Fields.BN_TYPE,_Fields.FROM_TID,_Fields.TO_TID,_Fields.ROOM_TID,_Fields.DATA_BINARY,_Fields.DATA_STRING,_Fields.IS_OFFLINE,_Fields.TIMESTAMP,_Fields.UDTYPE,_Fields.UDSHOW,_Fields.EXTEND,_Fields.EXTRA,_Fields.TO_LIST};
  ...
  public TimMessage(TimMessage other) {
    ...
    if (other.isSetToList()) {
      java.util.List<String> __this__ToList = new java.util.ArrayList<String>(other.ToList);
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<String> getToListIterator() {
    return (this.ToList == null) ? null : this.ToList.iterator();
  }

  public void addToToList(String elem) {
    if (this.ToList == null) {
      this.ToList = new java.util.ArrayList<String>();
    }
  ...
  public TimMessage setToList(@org.apache.thrift.annotation.Nullable java.util.List<String> ToList) {
    this.ToList = ToList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case TO_LIST:
      if (value == null) {
        ...
        setToList((java.util.List<String>)value);
      }
      break;
  ...
  public int compareTo(TimMessage other) {
    ...
    lastComparison = Boolean.compare(isSetToList(), other.isSetToList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetToList()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ToList = new java.util.ArrayList<String>(_list112.size);
                @org.apache.thrift.annotation.Nullable String _elem113;
                for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                {
                  _elem113 = iprot.readString();
                  struct.ToList.add(_elem113);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.extend != null) {
        if (struct.isSetExtend()) {
          oprot.writeFieldBegin(EXTEND_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, String> _iter115 : struct.extend.entrySet())
            {
      ...
      if (struct.extra != null) {
        if (struct.isSetExtra()) {
          oprot.writeFieldBegin(EXTRA_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, java.nio.ByteBuffer> _iter116 : struct.extra.entrySet())
            {
      ...
      if (struct.ToList != null) {
        if (struct.isSetToList()) {
          oprot.writeFieldBegin(TO_LIST_FIELD_DESC);
          {
            ...
            for (String _iter117 : struct.ToList)
            {
  ...
  private static class TimMessageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TimMessage> {
      ...
      if (struct.isSetExtend()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter118 : struct.extend.entrySet())
          {
      ...
      if (struct.isSetExtra()) {
        {
          ...
          for (java.util.Map.Entry<String, java.nio.ByteBuffer> _iter119 : struct.extra.entrySet())
          {
      ...
      if (struct.isSetToList()) {
        {
          ...
          for (String _iter120 : struct.ToList)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TimMessage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TMap _map121 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.extend = new java.util.HashMap<String, String>(2*_map121.size);
          @org.apache.thrift.annotation.Nullable String _key122;
          @org.apache.thrift.annotation.Nullable String _val123;
          for (int _i124 = 0; _i124 < _map121.size; ++_i124)
          {
            _key122 = iprot.readString();
            _val123 = iprot.readString();
            struct.extend.put(_key122, _val123);
          }
        }
        struct.setExtendIsSet(true);
      }
      if (incoming.get(13)) {
        {
          org.apache.thrift.protocol.TMap _map125 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.extra = new java.util.HashMap<String,java.nio.ByteBuffer>(2*_map125.size);
          @org.apache.thrift.annotation.Nullable String _key126;
          @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _val127;
          for (int _i128 = 0; _i128 < _map125.size; ++_i128)
          {
            _key126 = iprot.readString();
            _val127 = iprot.readBinary();
            struct.extra.put(_key126, _val127);
          }
        }
        struct.setExtraIsSet(true);
      }
